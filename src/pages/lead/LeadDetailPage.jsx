                ...
                {filesFromLead.length > 0 && (
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    {filesFromLead.map((doc, index) => {
                      let path = doc.path || "";
                      if (path.startsWith("uploads") && !path.startsWith("uploads/")) path = path.replace("uploads", "uploads/");
        ...
        <div className="fixed inset-0 z-50 flex justify-end">
          ...
          <div className="relative w-full max-w-[640px] h-full bg-white shadow-2xl flex flex-col">
            ...
            <div className="flex-1 overflow-y-auto px-6 py-6">
              <LeadForm initial={lead} loading={actionLoading} onSubmit={saveEditPanel} />
            </div>
