...
export default function SettingsPage() {
  ...
  return (
    <div className="animate-fade-in space-y-6 pb-12">
      ...
      <div className="rounded-3xl border border-gray-100 bg-white p-6 shadow-sm dark:border-white/10 dark:bg-slate-900">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            <span className="flex h-10 w-10 items-center justify-center rounded-xl bg-amber-100 text-amber-700 dark:bg-amber-900/30 dark:text-amber-300">
              <Icon name="mdi:palette-outline" className="h-5 w-5" />
            </span>
            <div>
              <h2 className="text-base font-bold text-gray-900 dark:text-white">Appearance & Theme Mode</h2>
              <p className="text-xs text-gray-500 dark:text-slate-400">
                Choose your default interface theme (Default is <strong>Light Mode</strong>). Changes apply instantly.
              </p>
            </div>
          </div>

          <div className="inline-flex rounded-2xl border border-gray-200 bg-slate-100 p-1 dark:border-white/10 dark:bg-slate-800">
            <button
            ...
            >
              <Icon name="mdi:white-balance-sunny" className="h-4 w-4 text-amber-500" />
              Light Theme (Default)
            </button>
            <button
            ...
            >
              <Icon name="mdi:weather-night" className="h-4 w-4 text-indigo-400" />
              Dark Mode
            </button>
          </div>
        </div>
